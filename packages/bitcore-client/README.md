...
No baseUrl flag will automatically create a wallet that points to http://api.omega.io:3000/api.
...
```sh
./wallet-register --name myregtestwallet --baseUrl http://api.omega.io:3000/api
```
